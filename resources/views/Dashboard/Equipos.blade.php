...
<body>
    ...
    <script>
        // ✅ CAMBIA EL ROL AQUÍ
        const ROL_USUARIO = "JUEZ"; // JUEZ | ESTUDIANTE | ADMIN
        ...
        function configurarVista() {
            ...
            <div class="subir-box">
                ...
                <button  onclick="location.href='info-evento.html'">Subir proyecto</button>
        ...
        `;
            ...
            if (ROL_USUARIO === "ADMIN") {
                ...
                panelExtra.innerHTML = `
            <div class="admin-box">
                <button class="btn-admin" onclick="location.href='info-evento.html'">
