    ...
    <div class="site-title-container" onclick="window.location='{{ route('dashboard') }}'" style="cursor: pointer;">
        ...
        <div class="user-menu-container">
            ...
            <div id="user-toggle" class="user-name">
                {{ $user->name }} <!-- Aquí mostramos el nombre del usuario desde la base de datos -->
...
<div class="profile-container">
    ...
    <div class="profile-form-box">
        ...
        <form class="profile-form">
            ...
            <label>Nombre:</label>
            <input type="text" value="{{ $user->name }}"> <!-- Mostramos el nombre del usuario desde la base de datos -->

            <label>Apellido:</label>
            <input type="text" value="{{ $user->last_name }}"> <!-- Agrega un campo para el apellido, si es necesario -->

            <label>Correo Electrónico:</label>
            <input type="email" value="{{ $user->email }}" disabled> <!-- Mostramos el correo del usuario -->

            <label>Número de celular:</label>
            <input type="tel" value="{{ $user->phone }}"> <!-- Agrega el teléfono si lo tienes en la base de datos -->
